...
const BreadcrumbList = React
  .forwardRef<HTMLOListElement, React.ComponentPropsWithoutRef<'ol'>>(
    ({ className, ...props }, ref) => (
      <ol
        ref={ref}
        className={cn(
...
const BreadcrumbLink = React
  ...
  >(({ asChild = false, className, ...props }, ref) => {
    ...
    return (
      <Comp
        ref={ref}
        className={cn('transition-colors text-blue-600 hover:text-blue-800 cursor-pointer', className)}
        {...props}
      />
    )
  })
...
const BreadcrumbPage = React
  .forwardRef<HTMLSpanElement, React.ComponentPropsWithoutRef<'span'>>(
    ({ className, ...props }, ref) => (
      <span
        ref={ref}
        role="link"
