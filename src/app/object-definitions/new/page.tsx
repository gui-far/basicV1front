...
export default function NewObjectDefinitionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to create object definition')
    } finally {
      setSaving(false)
    }
  }
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-2xl">Create Object Definition</CardTitle>
                <CardDescription>
                  Define a new dynamic object type with properties and Kanban workflow
                </CardDescription>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button type="submit" disabled={saving} className="cursor-pointer">
                  {saving ? 'Creating...' : 'Create Object Definition'}
                </Button>
              </div>
            </form>
          </CardContent>
